...
const GenerateInvoice = ({ invoice }: { invoice: DTOInvoices }) => {
  ...
  const fullName =
    `${invoice.client_first_name} ${invoice.client_second_name} ${invoice.client_first_lastname} ${invoice.client_second_lastname}`.trim();
          ...
          <Page size="LETTER" style={styles.page}>
            ...
            <View style={styles.serviceDetail}>
              ...
              <View style={styles.tableRow}>
                ...
                >{`${invoice.period_start} - ${invoice.period_end}`}</Text>
            ...
            <View style={styles.footer}>
              <Text style={styles.footerText}>
                Esta factura se asimila en sus efectos legales a una letra de
                cambio según el Art. 774 del Código de Comercio.
              </Text>
              <Text style={styles.footerText}>
                Después de vencida causará intereses de mora a la tasa máxima
                legal permitida.
              </Text>
            </View>
          </Page>
